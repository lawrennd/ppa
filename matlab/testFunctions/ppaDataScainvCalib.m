function ppaDataScaInvCalib(dataSet, dataSetNum, kernelType, scaVal,dataNum)
...
model.noise.sigma2 = scaVal-5e-7;

model.B = (1-scaVal-5e-7)^-1;
...
invWidthStr(46) = 'p';
save([HOME filesep 'mlprojects' filesep 'ppa' filesep 'icmlpaper' filesep dataSet filesep 'calibTests' filesep 'ppa_scainv' dataSet '_' num2str(dataSetNum) '_' kernelType{1} dataNumstr],  'll', ...
     'beta', 'kernParam', 'noiseParam', 'numIters','classError', 'aveInfoVal', 'scaVal')
