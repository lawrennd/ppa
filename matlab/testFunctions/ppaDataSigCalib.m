function ppaDataSigCalib(dataSet, dataSetNum, kernelType, sigVal,dataNum)
...
invWidthStr(46) = 'p';
save([HOME filesep 'mlprojects' filesep 'ppa' filesep 'icmlpaper' filesep dataSet filesep 'calibTests' filesep 'ppa_sig' dataSet '_' num2str(dataSetNum) '_' kernelType{1} dataNumstr],  'll', ...
