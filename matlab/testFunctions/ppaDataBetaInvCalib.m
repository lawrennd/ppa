function ppaDataBetaInvCalib(dataSet, dataSetNum, kernelType, betaVal,dataNum)
...
model.kern.comp{2}.variance = 1-betaVal-5e-7;
...
invWidthStr(46) = 'p';
save([HOME filesep 'mlprojects' filesep 'ppa' filesep 'icmlpaper' filesep dataSet filesep 'calibTests' filesep 'ppa_betainv' dataSet '_' num2str(dataSetNum) '_' kernelType{1} dataNumstr],  'll', ...
     'beta', 'kernParam', 'noiseParam', 'numIters','classError', 'aveInfoVal', 'betaVal')
