function fbarLike =ppaFBarNewLikelihood(model,minusqFbarGauss)
...
for i = 1 : size(model.B,2)
    ...
    normalCal = logConst -0.5.*logdetK - 0.5*logdetB;
    
    
      
    fbarLike = fbarLike + normalCal + fBarGauss + ffBarGauss ;
    
end
 fbarLike = fbarLike + minusqFbarGauss;
model.mu =mu;
model.invC = invC;
