function ppaDataBetaCalib(dataSet, dataSetNum, kernelType, betaVal,dataNum)
...
invWidthStr(46) = 'p';
save([HOME filesep 'mlprojects' filesep 'ppa' filesep 'icmlpaper' filesep dataSet filesep 'calibTests' filesep 'ppa_beta' dataSet '_' num2str(dataSetNum) '_' kernelType{1} dataNumstr],  'll', ...
