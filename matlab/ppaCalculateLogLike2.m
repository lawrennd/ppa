...
for i = 1:size(model.y, 2)
  ...
  part7 = 0;
  % this is the portion that depends on the noise model
%   for j=1:numData
...
%   end
  loglike = loglike + part1+part2+part3+part4+part5+part6;
end
loglike = loglike + noiseLogLikelihood(model.noise, m, 1./model.B, model.y);
