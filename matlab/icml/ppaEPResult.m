...
for dataSetNum = 1:10
    ...
    modelDat = load([HOME filesep 'mlprojects' filesep 'data'  filesep dataSet filesep 'EPResults' filesep 'ppa' dataSet '_' num2str(dataSetNum) '_' kernelType{1}]);
...
save([HOME filesep 'mlprojects' filesep 'data' filesep 'EPCompareResults' filesep dataSet kernelType{1} 'Results'], 'mLengthAv', ...
    'infoAv', 'classAv');     
