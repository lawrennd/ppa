function ppaPlotMultipleConvergenceResults2(dataNum)

% PPAPLOTMULTIPLECONVERGENCERESULTS2 A function that plots the comparisons between the KL likelihood and the
% standard variational likelihood for the two norm and german datasets, and
...
% Print figure
FILENAME = [baseDir  'ICMLconv' filesep 'twonorm_german_1_convFig.eps'];
