function L = ppaBetaLogLikelihood(model);

% PPABETALOGLIKELIHOOD Return the approximate log-likelihood for the PPA.
% FORMAT
% DESC Return the approximate log-likelihood for the PPA.
% ARG model : The current PPA model.
% RETURN L : The calculated value of the log-likelihood.
