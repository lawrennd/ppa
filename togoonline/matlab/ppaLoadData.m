function [X, y, XTest, yTest] = ppaLoadData(dataset, seedVal)

% PPALOADDATA Load a dataset.
% FORMAT
% DESC Load a dataset.
% ARG dataset : The data set we wish to load.
% ARG seedVal : The seed value for recreating experiments.
% RETURN X : The training inputs.
% RETURN y : The training labels.
% RETURN XTest : The test inputs.
% RETURN yTest : The test labels.
